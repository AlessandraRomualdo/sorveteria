    ...
    return(
        <div>
          ...
          <main className="limitar-secao">
            <section className="baner-sobre">
              <div className="titulo-baner-sobre">
                <h1>A GELATERIA</h1>
              </div>
            </section>
            ...
            <section className="info-sobre">
              ...
              <p>Somos uma empresa apaixonada pelo que faz. Colocamos amor em cada sorvete 
                ...
                receber elogios. Estamos operando desde 2009 com as melhores matérias-primas
                 ...
                 <p>Nossos clientes podem comprar os nossos sorvetes e degustar na nossa 
                  ...
                  em contato conosco. Iremos proporcionar o melhor atendimento e os melhores produtos
                   para você fazer a sua festa mais saborosa, com o melhor sorvete da cidade.</p>
            </section>

            <section className="conteiner-imgs">
              <div className="imgs">
                <img src="assets/sobre-image.jpg"alt="sobre"/>
                <img src="assets/sorveteria.jpg"alt="soverteria"/>
              </div>
            </section>
          </main>
          <Rodape/>  
